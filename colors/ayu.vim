...
let s:palette.tag       = {'dark': "#36A3D9",  'light': "#365fd9",  'mirage': "#5CCFE6"}
let s:palette.regexp    = {'dark': "#95E6CB",  'light': "#4CBF99",  'mirage': "#95E6CB"}
let s:palette.string    = {'dark': "#B8CC52",  'light': "#007711",  'mirage': "#BBE67E"}
let s:palette.function  = {'dark': "#FFB454",  'light': "#d15802",  'mirage': "#FFD57F"}
...
let s:palette.fg        = {'dark': "#E6E1CF",  'light': "#1a2026",  'mirage': "#D9D7CE"}
